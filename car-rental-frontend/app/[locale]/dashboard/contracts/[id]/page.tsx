...
export default function ContractDetailPage() {
  ...
  // Fetch KM alerts for this contract
  const {
    data: kmAlertsData,
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">{t("contractDetails")}</p>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="p-6 rounded-lg border bg-card">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold">{t("contractInformation")}</h2>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                {contract.actual_return_date && (
                  <div>
                    <p className="text-muted-foreground">{t("actualReturn")}</p>
            ...
            <div className="p-6 rounded-lg border bg-card">
              ...
              {contract.customer ? (
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <p className="text-muted-foreground">{t("customerType")}</p>
            ...
            {/* Vehicle Information */}
            <div className="p-6 rounded-lg border bg-card">
              <h2 className="text-lg font-semibold mb-4">{t("vehicleInformation")}</h2>
              {contract.vehicle ? (
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                  ...
                  {contract.end_mileage && (
                    <div>
                      <p className="text-muted-foreground">{t("endMileage")}</p>

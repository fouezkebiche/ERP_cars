  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">{isEdit ? t("edit") : t("newCustomer")}</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="p-6 rounded-lg border border-border bg-card">
          <h3 className="font-semibold mb-4">{t("customerType")}</h3>
          <div className="grid grid-cols-2 gap-4">
            <label className="flex items-center gap-2 p-4 rounded-lg border-2 cursor-pointer hover:bg-muted transition-colors">
              ...
              />
              <div>
                <p className="font-medium">{t("individual")}</p>
            ...
            <label className="flex items-center gap-2 p-4 rounded-lg border-2 cursor-pointer hover:bg-muted transition-colors">
              ...
              />
              <div>
                <p className="font-medium">{t("corporate")}</p>
        ...
        {/* Driver's License */}
        <div className="p-6 rounded-lg border border-border bg-card">
          <h3 className="font-semibold mb-4">{t("driversLicense")}</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium mb-2">{t("licenseNumber")}</label>
              <Input
            ...
            <div>
              <label className="block text-sm font-medium mb-2">{t("licenseExpiry")}</label>
              <Input
        ...
        <div className="p-6 rounded-lg border border-border bg-card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium mb-2">{t("emergencyContactName")}</label>
              <Input
            ...
            <div>
              <label className="block text-sm font-medium mb-2">{t("emergencyContactPhone")}</label>
              <Input
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center gap-2">
              <input
                ...
                checked={formData.apply_tier_discount}
                onChange={handleChange}
                className="w-4 h-4"
              />
              <span className="text-sm font-medium">{t("applyTierDiscount")}</span>
            </label>
            ...
            {isEdit && (
              <label className="flex items-center gap-2">
                <input
                  ...
                  className="w-4 h-4"
                />
                <span className="text-sm font-medium">{t("blacklistedLabel")}</span>
              </label>
            )}
          </div>
        </div>

    ...
    <ProtectedRoute requiredRoles={["owner", "admin", "accountant"]}>
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="p-4 rounded-lg border border-border bg-card">
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-sm text-muted-foreground">{t("totalPayrolls")}</p>
              </div>
            ...
            <div className="p-4 rounded-lg border border-border bg-card">
              <p className="text-sm text-muted-foreground mb-2">{t("byStatus")}</p>
              <div className="space-y-1 text-xs">
                ...
                {byStatus.length === 0 && (
                  <p className="text-muted-foreground">{t("noPayrolls")}</p>
                )}
              </div>
            </div>
          </div>
        ...
        <div className="rounded-lg border border-border overflow-hidden">
          <div className="bg-muted px-4 py-3 border-b border-border">
            <h2 className="font-semibold flex items-center gap-2">
              ...
              {t("payrollRecords")} ({filteredPayrolls.length})
            </h2>
          </div>
          <DataTable
            columns={[
        ...
        {calculateModalOpen && (
          <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
            <div className="bg-card rounded-lg p-6 w-full max-w-md">
              <h2 className="text-xl font-bold mb-4">{t("calculatePayrollTitle")}</h2>
              <form onSubmit={handleCalculate} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium mb-2">{t("selectEmployee")} *</label>
                  <Select
        ...
        {payModalOpen && selectedPayroll && (
          <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
            <div className="bg-card rounded-lg p-6 w-full max-w-md">
              <h2 className="text-xl font-bold mb-2">{t("markAsPaidTitle")}</h2>
              ...
              <form onSubmit={handleMarkAsPaid} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">{t("reference")}</label>
                  <Input

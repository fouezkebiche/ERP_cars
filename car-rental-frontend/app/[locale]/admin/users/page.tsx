    ...
    <div className="space-y-6 max-w-[1400px]">
      ...
      {error && (
        ...
        >
          ...
          <button onClick={() => load()} className="ml-auto text-xs underline" style={{ color: "#f87171" }}>
            {t("retry")}
          </button>
        </div>
      )}
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          { label: t("kpi.totalUsers"),       value: stats?.users?.total       ?? "—", icon: <Users size={16} />,     accent: "#818cf8" },
          { label: t("kpi.totalCompanies"),   value: stats?.companies?.total   ?? "—", icon: <Building2 size={16} />, accent: "#c084fc" },
          { label: t("kpi.activeCompanies"),  value: stats?.companies?.active  ?? "—", icon: <UserCheck size={16} />, accent: "#34d399" },
          ...
          >
            ...
            <div className="flex items-center justify-between mb-3">
              <p className="text-xs font-semibold uppercase tracking-widest"
                style={{ color: "rgba(129,140,248,0.6)", fontFamily: "monospace" }}>
                {label}
              </p>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <p className="ml-auto text-xs" style={{ color: "rgba(255,255,255,0.3)", fontFamily: "monospace" }}>
          {loading ? t("loading") : t("usersCount", { count: total })}
        </p>
      </div>
              ...
              <tr style={{ borderBottom: "1px solid rgba(129,140,248,0.08)" }}>
                {[
                  ...
                  <th
                    ...
                    style={{ color: "rgba(129,140,248,0.5)", fontFamily: "monospace" }}
                  >
                    {h}
                  </th>
                ))}

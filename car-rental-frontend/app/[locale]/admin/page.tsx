...
function StatusBadge({ status }: { status: string }) {
  ...
  const map: Record<string, { bg: string; color: string; label: string }> = {
    active:    { bg: "rgba(52,211,153,0.12)",  color: "#34d399", label: t("active") },
    trial:     { bg: "rgba(96,165,250,0.12)",   color: "#60a5fa", label: t("trial") },
    suspended: { bg: "rgba(248,113,113,0.12)",  color: "#f87171", label: t("suspended") },
    inactive:  { bg: "rgba(156,163,175,0.12)",  color: "#9ca3af", label: t("inactive") },
  }
  ...
  return (
    <div className="space-y-8 max-w-[1400px]">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-white" style={{ fontFamily: "monospace" }}>{t("dashboard")}</h1>

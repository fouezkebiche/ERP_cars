          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center gap-2">
              <input
                ...
                className="w-4 h-4"
              />
              <span className="text-sm font-medium">Apply tier discount</span>
            </label>
            <p className="text-xs text-muted-foreground">
              When enabled, this customer gets loyalty tier benefits (km bonus, overage discount). Turn off to charge base rates only.
            </p>
            {isEdit && (
              <label className="flex items-center gap-2">
                <input
